    ...
    <body>
        ...
        <main>
            <div class="row">
                ...
                <div class="center input-field col s3">
                    <button class="waves-effect waves-light btn" type="button"><a href="cadastrarExameTeorico.jsp">EXAME TEÓRICO</a></button>
                </div>
                <div class="center input-field col s3">
                    <button class="waves-effect waves-light btn" type="button"><a href="cadastrarExamePratico.jsp">EXAME PRÁTICO</a></button>
                </div>
            </div>
        </main>
