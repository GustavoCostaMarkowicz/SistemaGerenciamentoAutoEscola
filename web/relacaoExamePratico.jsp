...
<html>
    <head>
        ...
        <%
            ...
            List<ExamePratico> exames = cem.buscarTodosExamePraticos();
            int qtdE;
            String div = "";
    ...
    <body>
        ...
        <main>
            ...
            <%if(p == 1){%>
            <div class="row">
                <a href="relacaoExamePratico.jsp?p=2" class="grey lighten-5 waves-effect waves-light btn col s6" value="" style="color: gray;">Exibir Lista de Exames</a>
                <a href="relacaoExamePratico.jsp?p=1" class="red lighten-1 waves-effect waves-light btn col s6" value="">Exibir Calendário</a>
            </div>
            <%}else{%>
            <div class="row">
                <a href="relacaoExamePratico.jsp?p=2" class="red lighten-1 waves-effect waves-light btn col s6" value="">Exibir Lista de Exames</a>
                <a href="relacaoExamePratico.jsp?p=1" class="grey lighten-5 waves-effect waves-light btn col s6" value="" style="color: gray;">Exibir Calendário</a>
            </div>
            <%}%>
            <div class="row">
                <div class="col s14 m12">
                    <div class="card">
                        ...
                        <div class="card-image">
                            <a href="cadastrarExamePratico.jsp" class="tooltipped btn-floating btn-large halfway-fab waves-effect waves-light green" data-position="left" data-tooltip="cadastrar um novo exame prático"><i class="material-icons">add</i></a>
                        </div>
                        <%}%>
                        <div class="card-content">
                                    ...
                                    <tr>
                                        ...
                                        <%
                                            ...
                                            for (int k = diaSControle; k <= 6; k++) {
                                                qtdE = 0;
                                                for (ExamePratico e : exames) {
                                                    if (e.getDataExame().getDate() == dia & e.getDataExame().getMonth() == mes & e.getDataExame().getYear() == new Date().getYear() & e.isVisivel()) {
                                                        qtdE++;
                                                    }
                                                }
                                                if (qtdE == 1) {
                                                    div = String.valueOf(qtdE) + " exame<br>prático";
                                                } else {
                                                    div = String.valueOf(qtdE) + " exames<br>práticos";
                                                }
                                                if (qtdE > 0) {
                                        %>
                                        <td class="menu" ><a href="examesCalendario.jsp?dia=<%=dia%>&p=2"><div class="dia" style="height:100%;width:100%;"><%=dia + "<br>"%><i style="font-size: 15px; color: green;" class="material-icons">event</i><label class="dataEx"><%=div%></label></div></a></td> 
                                                    <%
                                                        dia++;
                                                    } else {
                                                    %>
                                        <td class="menu" ><a href="cadastrarExamePratico.jsp"><div class="dia" style="height:100%;width:100%;"><%=dia%></div></a></td> 
                                            <%
                                                        dia++;
                                                    }
                                                }
                                                ...
                                                for (int k = diaSControle; k <= 6; k++) {
                                                    if (dia == diaF) {
                                                        ...
                                                        if (qtdE == 1) {
                                                            div = String.valueOf(qtdE) + " exame prático";
                                                        } else {
                                                            div = String.valueOf(qtdE) + " exames práticos";
                                                        }
                                                        if (qtdE > 0) {
                                            %><td class="menu" ><a href="examesCalendario.jsp?dia=<%=dia%>&p=2"><div class="dia" style="height:100%;width:100%;"><%=dia + "<br>"%><i style="font-size: 15px; color: green;" class="material-icons">event</i><label class="dataEx"><%=div%></label></div></a></td> <%
                                            } else {
                            ...
                            <div class="card">
                                <div class="row">
                                    ...
                                    <div class="center input-field col s10">
                                        ...
                                        <label for="consulta"><i class="material-icons">search</i>Pesquisar exame prático</label>
                                    </div>
                                    <div class="center col s1">
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <table id="tabelaExames" name="tabelaExames" class="centered striped">
                                    ...
                                    <tbody>
                                        <%                        
                                            ...
                                            ControleExamePratico controleExame = new ControleExamePratico();
                                        ...
                                        <tr>
                                            ...
                                            <td><%=e.getInstrutor().getNomeCompleto()%></td>
                                            <td><%=e.getVeiculo().getPlaca()%></td>
                                ...
                                <div align="center">
                                    <label id="noResultMessage" name="noResultMessage">Nenhum exame prático encontrado</label>
                                </div>
