...
public class GerarNumeroExtenso {
    ...
    */
   public GerarNumeroExtenso(BigDecimal dec) {
      this();
      setNumber(dec);
   }
    ...
    *@param  dec  valor para colocar por extenso
    */
   public GerarNumeroExtenso(double dec) {
      this();
      setNumber(dec);
   }
...
//	         }
   ...
   public static void main(String[] args) {
      ...
      GerarNumeroExtenso teste = new GerarNumeroExtenso(new BigDecimal(args[0]));
